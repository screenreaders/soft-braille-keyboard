...
public class BrlttyWrapper {
    ...
    public BrailleInputEvent readInputEvent() {
        return readInputEventNative();
    }

    public void configureRawRemap(String[] signatures, int[] targetCommands,
            int[] targetArgumentModes, int[] targetArgumentValues) {
        configureRawRemapNative(signatures, targetCommands,
                targetArgumentModes, targetArgumentValues);
    }
    ...
    private String deviceBrlttyAddress() {
        return mDeviceInfo.getBrlttyAddress();
    }
    ...
    private native BrailleInputEvent readInputEventNative();
    private native void configureRawRemapNative(String[] signatures,
            int[] targetCommands, int[] targetArgumentModes,
            int[] targetArgumentValues);
